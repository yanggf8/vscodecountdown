...
exports.CountdownOptionsViewProvider = void 0;
const vscode = __importStar(require("vscode"));
class CountdownOptionsViewProvider {
    constructor(_extensionUri, _onTimerSelected) {
        this._extensionUri = _extensionUri;
        this._onTimerSelected = _onTimerSelected;
    }
    ...
    hide() {
        var _a, _b;
        if (this._view) {
            (_b = (_a = this._view).show) === null || _b === void 0 ? void 0 : _b.call(_a, false);
        }
    }
...
exports.CountdownOptionsViewProvider = CountdownOptionsViewProvider;
CountdownOptionsViewProvider.viewType = 'countdownOptions';
